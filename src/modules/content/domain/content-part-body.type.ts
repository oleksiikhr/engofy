...
// Unlike NodeTreeType (Content.body), this does not validate shape on read via
// parseDoc — a ContentPart body is a Paragraph or ListItem fragment, and which
...
export class ContentPartBodyType extends JsonType {
