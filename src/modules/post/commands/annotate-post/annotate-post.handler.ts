  ...
  implements ICommandHandler<AnnotatePostCommand>
{
  ...
  // Post processed at the same time, same lemma/phrase) comes from the
  ...
  // concurrent annotate-post jobs racing to create the same lemma (e.g.
  // "the" appearing in two different Post rows processed in the same
