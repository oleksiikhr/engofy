...
### [x] 3. Сповіщення про публікацію поста
- Branch: `pipeline-observability-03-publish-notice`
- Base: `main`
- PR: https://github.com/oleksiikhr/engofy/pull/75
...
### [x] 4. Сторож для завислих постів
- Branch: `pipeline-observability-04-stuck-watchdog`
- Base: `main`
- PR: https://github.com/oleksiikhr/engofy/pull/76
