...
### [ ] 2. Мобільний рідер: менше плашок і нижній лист
- Branch: `guest-reader-ux-round-2-02-mobile-reader-density`
- Base: `guest-reader-ux-round-2-01-guest-signup-nudge`
- PR: —
...
### [ ] 3. Головна: робочий міні-рідер і чистка Pricing
- Branch: `guest-reader-ux-round-2-03-home-live-reader`
- Base: `guest-reader-ux-round-2-02-mobile-reader-density`
- PR: —
