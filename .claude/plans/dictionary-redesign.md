...
### [ ] 1. Список /dictionary: бекенд + фронтенд разом
...
для реалізатора:** пагінувати по лема-групі чи по сирому рядку — впливає на дизайн
курсора, зафіксувати при реалізації цього зрізу). `dictionary.astro` переписується
під новий запит, клієнтський JS-фільтр прибирається.
