...
- [ ] **10 — small code changes** — disable Swagger in prod; `/_healthz` behaviour when Redis is down (maybe split liveness/readiness); confirm `TRUST_PROXY` value semantics.
